...
for lt, ln, el in zip(lat, lon, elev):
    fgv.add_child(folium.CircleMarker(location=[lt, ln], radius=6, popup=str(el) + " m", fill_color = color_producer(el), color = 'grey', fill_opacity=0.7, tooltip=folium.Tooltip(text = str(el))))

fgp = folium.FeatureGroup(name="Populaiton")
