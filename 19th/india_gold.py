...
fg.add_child(folium.GeoJson(data=open('india_telengana.json', 'r', encoding='utf-8-sig').read(), style_function=lambda x: {'fillColor': 'green' if x['properties']["NAME_1"] == "Andhra Pradesh" else 'orange'}))
